...
public class Compressor {
    ...
    public File compressToFile(byte[] data,String name) throws IOException {
        return ImageUtil.compressImage(data, maxWidth, maxHeight, compressFormat, quality,
                destinationDirectoryPath + File.separator + name);
    }
    ...
    public Bitmap compressToBitmap(byte[] data) throws IOException {
        return ImageUtil.decodeSampledBitmapFromFile(data, maxWidth, maxHeight);
    }
