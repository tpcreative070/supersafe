package co.tpcreative.supersafe.commonimport
...
object Navigator {
    ...
    fun onMoveSetPin(context: Context?, action: EnumPinAction?) {
        val intent: Intent = EnterPinActivity.Companion.getIntent(context, EnumPinAction.SET.ordinal, action.ordinal)
        context.startActivity(intent)
    }

    fun onMoveToVerifyPin(activity: Activity?, action: EnumPinAction?) {
        val intent: Intent = EnterPinActivity.Companion.getIntent(activity, EnumPinAction.VERIFY.ordinal, action.ordinal)
    ...
    fun onMoveToChangePin(context: Context?, action: EnumPinAction?) {
        val intent: Intent = EnterPinActivity.Companion.getIntent(context, EnumPinAction.INIT_PREFERENCE.ordinal, action.ordinal)
        context.startActivity(intent)
    }

    fun onMoveToFakePin(context: Context?, action: EnumPinAction?) {
        val intent: Intent = EnterPinActivity.Companion.getIntent(context, EnumPinAction.VERIFY_TO_CHANGE_FAKE_PIN.ordinal, action.ordinal)
        context.startActivity(intent)
    }

    fun onMoveToResetPin(context: Context?, action: EnumPinAction?) {
        val intent: Intent = EnterPinActivity.Companion.getIntent(context, EnumPinAction.RESET.ordinal, action.ordinal)
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK)
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
        context.startActivity(intent)
    }
    ...
    fun onMoveAlbumDetail(context: Activity?, mainCategories: MainCategoryModel?) {
        ...
        intent.putExtras(bundle)
        context.startActivityForResult(intent, Navigator.ALBUM_DETAIL)
    }
    ...
    fun onPhotoSlider(context: Activity?, items: ItemModel?, mList: MutableList<ItemModel?>?, mainCategories: MainCategoryModel?) {
        ...
        bundle.putSerializable(context.getString(R.string.key_main_categories), mainCategories)
        intent.putExtras(bundle)
        context.startActivityForResult(intent, Navigator.PHOTO_SLIDE_SHOW)
    }

    fun onSettings(context: Activity?) {
        val intent = Intent(context, SettingsActivity::class.java)
        context.startActivityForResult(intent, Navigator.COMPLETED_RECREATE)
    }
