package co.tpcreative.supersafe.common.encyptimportimport

android.net.Uriimport android.util.Logimport com.google.android.exoplayer2.upstream.DataSourceimport java.io.*import java.lang.Exceptionimport

java.math.BigIntegerimport java.util.*
import javax.crypto.Cipherimport

javax.crypto.CipherInputStreamimport javax.crypto.spec.IvParameterSpecimport javax.crypto.spec.SecretKeySpec
...
class EncryptedFileDataSource(cipher: Cipher?, secretKeySpec: SecretKeySpec?, ivParameterSpec: IvParameterSpec?, listener: TransferListener<in EncryptedFileDataSource?>?) : DataSource {
    ...
    class StreamingCipherInputStream(inputStream: InputStream?, cipher: Cipher?, secretKeySpec: SecretKeySpec?, ivParameterSpec: IvParameterSpec?) : CipherInputStream(inputStream, cipher) {
        ...
        fun forceSkip(bytesToSkip: Long): Long {
            ...
            try {
                val skip = (bytesToSkip % AES_BLOCK_SIZE) as Int
                ...
                Arrays.fill(skipBuffer, 0 as Byte)
            } catch (e: Exception) {
                return 0
            }
            return skipped
