...
abstract class BaseGalleryActivity : AppCompatActivity(), OnGalleryAttachedListener, SensorFaceUpDownChangeNotifier.Listener {
    ...
    protected override fun onResume() {
        Utils.Companion.Log(TAG, "Action here........onResume")
    ...
    protected fun onRegisterHomeWatcher() {
        ...
        mHomeWatcher.setOnHomePressedListener(object : OnHomePressedListener {
            ...
            override fun onHomeLongPressed() {
                Utils.Companion.Log(TAG, "Pressed long home button")
            }
        })
    ...
    protected override fun onStart() {
        ...
        if (SingletonManager.Companion.getInstance().isAnimation()) {
            ...
            Utils.Companion.Log(TAG, "onStartBaseGalleryActivity")
        }
    }
