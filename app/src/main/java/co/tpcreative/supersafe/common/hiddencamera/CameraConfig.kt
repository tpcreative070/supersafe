...
class CameraConfig {
    ...
    fun getBuilder(context: Context?): co.tpcreative.supersafe.common.hiddencamera.CameraConfig.Builder? {
        mContext = context
        return co.tpcreative.supersafe.common.hiddencamera.CameraConfig.Builder()
    }
    ...
    inner class Builder {
         ...
         */
        fun setCameraResolution(@SupportedResolution resolution: Int): co.tpcreative.supersafe.common.hiddencamera.CameraConfig.Builder? {
         ...
         * @see CameraFacing
         */
        fun setCameraFacing(@SupportedCameraFacing cameraFacing: Int): co.tpcreative.supersafe.common.hiddencamera.CameraConfig.Builder? {
            //Validate input
         ...
         * @see CameraFacing
         */
        fun setCameraFocus(@SupportedCameraFocus focusMode: Int): co.tpcreative.supersafe.common.hiddencamera.CameraConfig.Builder? {
            //Validate input
         ...
         */
        fun setImageFormat(@SupportedImageFormat imageFormat: Int): co.tpcreative.supersafe.common.hiddencamera.CameraConfig.Builder? {
            //Validate input
         ...
         * @see CameraRotation
         */
        fun setImageRotation(@SupportedRotation rotation: Int): co.tpcreative.supersafe.common.hiddencamera.CameraConfig.Builder? {
            //Validate input
        ...
        private fun getDefaultStorageFile(): File {
            return File(SuperSafeApplication.Companion.getInstance().getSupersafeBreakInAlerts()
                    + File.separator
