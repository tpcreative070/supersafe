package co.tpcreative.supersafe.ui.verifyimport
...
class VerifyActivity : BaseActivityNoneSlide(), BaseView<Any?>, OnEditorActionListener {
    ...
    protected override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val result: String = Utils.Companion.getFontString(R.string.verify_title, presenter.user.email)
    ...
    override fun onEditorAction(textView: TextView?, actionId: Int, keyEvent: KeyEvent?): Boolean {
        if (actionId == EditorInfo.IME_ACTION_NEXT) {
            if (!SuperSafeReceiver.Companion.isConnected()) {
                Utils.Companion.showDialog(this@VerifyActivity, getString(R.string.internet))
                return false
            }
            if (isNext) {
                Log.d(TAG, "Next")
