...
class PinLockView : RecyclerView {
    ...
    private var mCustomKeySet: IntArray?
        ...
        override fun onNumberClicked(keyValue: Int) {
            if (mPin.length < getPinLength()) {
                ...
                if (mPinLockListener != null) {
                    ...
                    Utils.Companion.Log(TAG, "mPinLockListener is null")
                }
            } else {
    ...
    private val mOnVerifyClickListener: OnVerifyClickListener? = object : OnVerifyClickListener {
