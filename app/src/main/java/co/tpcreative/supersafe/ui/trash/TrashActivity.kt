package co.tpcreative.supersafe.ui.trashimport
...
import co.tpcreative.supersafe.ui.trash.TrashAdapter
...
class TrashActivity : BaseActivity(), BaseView<Any?>, TrashAdapter.ItemSelectedListener {
