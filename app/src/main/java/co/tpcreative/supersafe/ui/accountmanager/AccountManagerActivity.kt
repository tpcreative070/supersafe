package co.tpcreative.supersafe.ui.accountmanagerimport
...
class AccountManagerActivity : BaseGoogleApi(), BaseView<Any?>, AccountManagerAdapter.ItemSelectedListener {
    ...
    fun initRecycleView() {
        ...
        if (recyclerView == null) {
            Utils.Companion.Log(TAG, "recyclerview is null")
        }
    ...
    fun onSignOut(view: View?) {
        Utils.Companion.Log(TAG, "sign out")
        val mUser: User = Utils.Companion.getUserInfo()
        if (mUser != null) {
