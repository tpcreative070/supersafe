...
class BreakInAlertsActivity : BaseActivity(), BaseView<Any?>, CompoundButton.OnCheckedChangeListener, BreakInAlertsAdapter.ItemSelectedListener {
    ...
    override fun onOptionsItemSelected(item: MenuItem?): Boolean {
        when (item.getItemId()) {
            R.id.menu_item_select_all -> {
                ...
                Utils.Companion.showDialog(this, getString(R.string.are_you_sure_delete_all_items), object : ServiceManagerSyncDataListener {
                ...
                .withListener(object : MultiplePermissionsListener {
                    override fun onPermissionsChecked(report: MultiplePermissionsReport?) {
                        ...
                        if (report.isAnyPermissionPermanentlyDenied()) {
                            PrefsController.putBoolean(getString(R.string.key_break_in_alert), false)
                            btnSwitch.setChecked(false)
                            /*Miss add permission in manifest*/Utils.Companion.Log(TAG, "request permission is failed")
                        }
                    }
