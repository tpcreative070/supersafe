package co.tpcreative.supersafe.ui.albumcoverimport
...
import co.tpcreative.supersafe.ui.albumcover.AlbumCoverDefaultAdapter
...
class AlbumCoverActivity : BaseActivity(), BaseView<Any?>, CompoundButton.OnCheckedChangeListener, AlbumCoverAdapter.ItemSelectedListener, AlbumCoverDefaultAdapter.ItemSelectedListener {
    ...
    override fun onSuccessful(message: String?, status: EnumStatus?) {
        when (status) {
            ...
            EnumStatus.GET_LIST_FILE -> {
                Utils.Companion.Log(TAG, "load data")
