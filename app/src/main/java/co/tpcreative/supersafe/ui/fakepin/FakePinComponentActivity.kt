package co.tpcreative.supersafe.ui.fakepinimport
...
class FakePinComponentActivity : BaseActivityNoneSlideFakePin(), BaseView<Any?>, FakePinComponentAdapter.ItemSelectedListener, SingletonFakePinComponent.SingletonPrivateFragmentListener {
    ...
    protected override fun onResume() {
        ...
        presenter.getData()
        SingletonFakePinComponent.Companion.getInstance().setListener(this)
        onRegisterHomeWatcher()
        SingletonManager.Companion.getInstance().setVisitFakePin(true)
