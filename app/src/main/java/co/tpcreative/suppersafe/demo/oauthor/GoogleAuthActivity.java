...
public class GoogleAuthActivity extends SimpleAuthActivity
  ...
  private static final String KEY_IS_GOOGLE_DISCONNECT_REQUESTED =  "KEY_IS_GOOGLE_DISCONNECT_REQUESTED";
  private static final String KEY_IS_GOOGLE_REVOKE_REQUESTED =  "KEY_IS_GOOGLE_REVOKE_REQUESTED";
  ...
  protected void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    if (requestCode != RC_SIGN_IN || resultCode != RESULT_OK) {
      handCancel();
      Log.d(TAG,"Cancel :121 :" + requestCode);
      return;
    }
