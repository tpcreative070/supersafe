...
public abstract class AbstractDataBinder<DataType, KeyType, ViewType, ParamType> extends Handler {
    ...
    public interface Listener<DataType, KeyType, ViewType, ParamType> {
         ...
         *
         * @param dataBinder
         *         The observed data binder as an instance of the class {@link AbstractDataBinder}.
        ...
        boolean onLoadData(
                @NonNull AbstractDataBinder<DataType, KeyType, ViewType, ParamType> dataBinder,
        ...
        void onFinished(
                @NonNull AbstractDataBinder<DataType, KeyType, ViewType, ParamType> dataBinder,
                @NonNull final KeyType key, @Nullable DataType data, @NonNull final ViewType view,
