...
public class MaterialStyledDialog extends DialogBase {
    ...
    private static final String TAG = MaterialStyledDialog.class.getSimpleName();
    ...
    private View initStyle(final Builder builder) {
        ...
        CheckBox checkBox = (CheckBox) contentView.findViewById(R.id.md_styled_dialog_checkbox);
        TextView text = (TextView) contentView.findViewById(R.id.md_styled_dialog_text);
        LinearLayout llCheckbox = contentView.findViewById(R.id.ll_md_styled_dialog_checkbox);
        ...
        if (builder.isCheckbox){
            if (builder.checkboxListener!=null){
                checkBox.setOnCheckedChangeListener(builder.checkboxListener);
            }
            if (builder.checkBoxText!=null){
                text.setText(builder.checkBoxText);
            }
        }
        else{
    ...
    public static class Builder implements IBuilder {
        ...
        protected boolean isIconAnimation, isDialogAnimation, isDialogDivider, isCancelable, isScrollable, isDarkerOverlay, isAutoDismiss,isCheckbox; // withIconAnimation(), withDialogAnimation(), withDivider(), setCancelable(), setScrollable(), withDarkerOverlay(), autoDismiss()
        ...
        @Override
        public Builder setCheckBox(@NonNull boolean checkbox,@StringRes int text) {
            this.isCheckbox = checkbox;
            this.checkBoxText = context.getString(text);
            return this;
        }

        @Override
        public Builder setCheckBox(@NonNull boolean checkbox,@StringRes int text, CompoundButton.OnCheckedChangeListener listener) {
            this.isCheckbox = checkbox;
            this.checkBoxText = context.getString(text);
