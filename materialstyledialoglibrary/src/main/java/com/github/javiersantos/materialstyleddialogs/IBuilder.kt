...
internal interface IBuilder {
    ...
    fun setCheckBox(@NonNull checkbox: Boolean, @StringRes titleRes: Int): MaterialStyledDialog.Builder?

    fun setCheckBox(@NonNull checkbox: Boolean, @StringRes titleRes: Int, listener: CompoundButton.OnCheckedChangeListener): MaterialStyledDialog.Builder?
