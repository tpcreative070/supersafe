...
interface IBuilder {
    ...
    MaterialStyledDialog.Builder setCheckBox(@NonNull boolean checkbox,@StringRes int titleRes);

    MaterialStyledDialog.Builder setCheckBox(@NonNull boolean checkbox,@StringRes int titleRes, CompoundButton.OnCheckedChangeListener listener);
