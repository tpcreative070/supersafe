...
class MaterialStyledDialog(
    ...
    private fun initStyle(builder: Builder): View {
        ...
        val checkBox  = contentView.findViewById(R.id.md_styled_dialog_checkbox) as AppCompatCheckBox
        val text = contentView.findViewById(R.id.md_styled_dialog_text) as AppCompatTextView
        val llCheckbox = contentView.findViewById(R.id.ll_md_styled_dialog_checkbox) as LinearLayout
        if (builder.isCheckBoxPrompt){
            if (builder.checkboxListener!=null){
                checkBox.setOnCheckedChangeListener(builder.checkboxListener)
            }
            if (builder.checkBoxText!=null){
                text.text = builder.checkBoxText
            }
        }
        else{
    ...
    class Builder(var context: Context) : IBuilder {
        ...
        override fun setCheckBox(checkbox: Boolean, titleRes: Int): Builder {
            this.isCheckBoxPrompt = checkbox;
            this.checkBoxText = context.getString(titleRes);
            return this
        }

        override fun setCheckBox(checkbox: Boolean, titleRes: Int, listener: CompoundButton.OnCheckedChangeListener): Builder {
            this.isCheckBoxPrompt = checkbox
            this.checkBoxText = context.getString(titleRes)
