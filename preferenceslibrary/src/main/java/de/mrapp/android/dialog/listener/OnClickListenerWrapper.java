...
/**
 * A wrapper, which implements the interface {@link View.OnClickListener} in order to
...
public class OnClickListenerWrapper extends AbstractListenerWrapper
    ...
    /**
     * Creates a new wrapper, which implements the interface {@link View.OnClickListener}
